  ...
  return (
    <form className='relative cursor-pointer h-10' onClick={() => open(<div>Finder</div>)}>
      ...
      <input
        type='text'
        id='findInput'
        className='cursor-pointer border rounded-lg border-black/10 dark:border-white/20 w-full h-full bg-balck/5 bg-black/[3] dark:bg-white/5 outline-none px-7 transition-colors hover:bg-black/5 dark:hover:bg-white/10'
        readOnly
      />
